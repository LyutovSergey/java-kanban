...
public class HttpTaskManagerHystoryTest {
    ...
    @Test
    public void testHystory() throws IOException, InterruptedException {
        // Тест пустой истории
        ...
        assertEquals("[]", response.body(),"Список истории не пустой");

        // Тест истории c удаление объекта
        ...
        assertEquals(200, response.statusCode(),"Код ответа не соответствует эталонному");
        assertEquals(json, response.body(),"Список истории не совпадает");
