...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Task task1 = new Task("Сдать спринт 4", "Необходимо сдать 4 спринт для продолжения обучения",Status.NEW);
        Task task2 = new Task("Пройти теорию 5 спринта", "Необходимо сдать 5 спринт для продолжения обучения",Status.NEW);
        ...
        Subtask subtask1 = new Subtask("Подзадача 1 Эпика 1: Реализовать ТЗ",
                "Описание Подзадача 1", Status.NEW, epic1.getId());
        Subtask subtask2 = new Subtask("Подзадача 2 Эпика 1: Отправить ТЗ на проверку",
                "Описание Подзадача 2", Status.NEW,epic1.getId());
        Subtask subtask3 = new Subtask("Подзадача 1 Эпика 2: Пройти теорию Спринта 5",
                "Описание Подзадача 1", Status.NEW,epic2.getId());
        Subtask subtask4 = new Subtask("Подзадача 2 Эпика 2: Реализовать ТЗ",
                "Описание Подзадача 2", Status.NEW,epic2.getId());
        ...
        System.out.println("\n================ Тест 9 ==================");
        System.out.println("Получаем подзадачу по Id=6");
        ...
        System.out.println("\n================ Тест 11 ==================");
        System.out.println("Получаем подзадачи Эпика по Id=3");
        ...
        System.out.println("\n================ Тест 15 ==================");
        System.out.println("Добавляем Подзадачу");
        Subtask subtask5 = new Subtask("Подзадача 1 Эпика 2: Реализовать ТЗ",
                "Описание Подзадача 1", Status.NEW, epic2.getId());
        ...
        System.out.println("\n================ Тест 17 ==================");
        System.out.println("Добавляем подзадачу");
        Subtask subtask6 = new Subtask("Подзадача 1 Эпика 1: Реализовать ТЗ",
                "Описание Подзадача 1", Status.NEW, epic1.getId());
